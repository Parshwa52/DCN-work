...
public class MyClass {
    ...
    public static void main(String args[]) 
    {
        ...
        test_correct_errors(codeword1,row_parity,col_parity);
        System.out.println("--------------------------------------------------------------");
        int[][] codeword2={{0, 1, 1, 1}, {1, 1, 1, 0}};
        row_parity[0]=1;
        row_parity[1]=0;
        col_parity[0]=1;
        col_parity[1]=0; 
        col_parity[2]=0;
        col_parity[3]=0;
        System.out.println("Case 2 : Single bit error detection and correction");
        test_correct_errors(codeword2,row_parity,col_parity);
        System.out.println("--------------------------------------------------------------");
        int[][] codeword3={{0, 1, 1, 1}, {1, 1, 1, 0}};
        row_parity[0]=1;
        row_parity[1]=1;
        col_parity[0]=0;
        col_parity[1]=0; 
        col_parity[2]=0;
        col_parity[3]=0;
        System.out.println("Case 3 : Uncorrectable error");
        test_correct_errors(codeword3,row_parity,col_parity);
        System.out.println("--------------------------------------------------------------");
    }
    ...
    public static void test_correct_errors(int codeword1[][],int row_parity[],int col_parity[])
    {
